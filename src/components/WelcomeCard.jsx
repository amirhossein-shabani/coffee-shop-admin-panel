...
export default function WelcomeCard({ isViewer, userProfile }) {
  ...
  return (
    <div className="flex flex-col p-4 mt-4 text-center bg-white rounded-lg shadow-sm md:flex-row gap-x-5 ">
      <div className="flex items-center justify-between mb-1 md:w-1/4">
      ...
      <div className="flex items-center w-full md:w-3/4 gap-2 mt-3 overflow-x-auto md:justify-center md:gap-x-4 md:mt-0 ">
        <button
